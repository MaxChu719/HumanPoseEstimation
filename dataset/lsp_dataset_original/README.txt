Leeds Sports Pose Dataset (Original size images)
...
gathered from Flickr. The file joints.mat contains 14 joint 
locations for each image along with a binary value specifying 
joint visibility.
